...
namespace Rocky.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Upsert(int? id)
        {
            ...
            //ViewBag.CategoryDropDown = CategoryDropDown;  // Образец, но лучше делать это через ViewModel
        ...
        {
            //if (ModelState.IsValid)  // ЗДЕСЬ ОШИБКА, НЕ ПОНИМАЮ ПОЧЕМУ
            //{
        ...
        public IActionResult Delete(int? id)
        {
            ...
            // product.Category = _db.Category.Find(product.CategoryId); // Пример 
